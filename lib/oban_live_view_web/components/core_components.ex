defmodule ObanLiveViewWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(ObanLiveViewWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(ObanLiveViewWeb.Gettext, "errors", msg, opts)
    end
  end
